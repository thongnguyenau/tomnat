...
<template>
  <div>
    <div class="tw-p-6 sm:tw-px-20 tw-bg-white tw-border-b tw-border-gray-200">
      <div>
        <ApplicationLogo class="tw-block tw-h-12 tw-w-auto" />
      </div>

      <div class="tw-mt-8 tw-text-2xl">
        Welcome to your Jetstream application!
      </div>

      <div class="tw-mt-6 tw-text-gray-500">
    ...
    <div
      class="
        tw-bg-gray-200 tw-bg-opacity-25 tw-grid tw-grid-cols-1
        md:tw-grid-cols-2
      "
    >
      <div class="tw-p-6">
        <div class="tw-flex tw-items-center">
          ...
          <div
            class="
              tw-ml-4 tw-text-lg tw-text-gray-600 tw-leading-7 tw-font-semibold
            "
          >
        ...
        <div class="tw-ml-12">
          ...
          <a href="https://laravel.com/docs">
            ...
            >
              ...
              <div class="tw-ml-1 tw-text-indigo-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
      ...
      <div class="tw-p-6 tw-border-t tw-border-gray-200 md:tw-border-l">
        <div class="tw-flex tw-items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
